...
def check_unique_vals(tree) -> list:
...
if __name__ == '__main__':
    ...
    for i in range(5):
        ...
        vals = check_unique_vals(tree)
        assert(rndmInt == len(vals))
        dump_to_file.dump_to_json_file(tree.flatten(), 'Legal_BT_DV/legal_bt_{0}.json'.format(i + 1))